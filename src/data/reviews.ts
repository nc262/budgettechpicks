...
export const reviews: Record<string, OurTake> = {
  ...
  // ── Wave 4: completing the catalog (100% coverage) ──────────────────────
  "pixel-art-display": {
    whyItWins: "A Wi-Fi pixel canvas that's equal parts clock, notifier, and art piece. The MOCREO shows time, weather, and animations on a crisp LED grid, pulls designs over Wi-Fi, and turns a corner of your desk into something alive without being loud about it.",
    whoItsFor: "Desk decorators and gift-buyers who want ambient personality with a practical clock/weather function. Minimalists and anyone who'll resent another app and account should pass.",
    longTerm: "Simple LED hardware with little to fail; the experience depends on continued app support, which is the thing to watch with smaller brands. Desk-powered, so there's no battery to age.",
    watchOut: "Setup runs through a phone app that wants Wi-Fi and an account — grant the minimum. The grid resolution is low by design (that's the charm), so don't expect photo detail.",
  },
  "magnetic-sculpture": {
    whyItWins: "The fidget toy that doubles as desk art. 216 magnetic balls you can build into endless shapes — a genuinely satisfying way to keep your hands busy on a call, and it looks deliberate sitting in a cube when you're done.",
    whoItsFor: "Fidgeters, tactile thinkers, and anyone who wants a cheap desk object that's interactive rather than static. Households with small kids or pets should skip it outright (see below).",
    longTerm: "Nothing electronic to break — these last indefinitely as long as you don't lose the balls. The included case keeps the set together, which is the main longevity factor.",
    watchOut: "Serious safety note: swallowed magnets cause severe internal injury — keep far from children and pets, full stop. The balls also attract dust and stick to anything ferrous on your desk.",
  },
  "anki-vector-robot": {
    whyItWins: "A genuinely charming little AI robot that roams your desk, recognizes faces, answers questions, and reacts with real personality. Vector isn't a remote-control toy — it's autonomous and expressive, the closest thing to a Pixar character living on your desk.",
    whoItsFor: "Gadget lovers, gift-givers wanting a 'wow,' and anyone who finds a roaming robot companion delightful. Practical buyers who want a function, not a personality, won't get the appeal.",
    longTerm: "Important history: Anki shut down in 2019 and Digital Dream Labs revived the platform — Vector is cloud-dependent and has already survived one corporate death, so it's a bet on continued server support. Newer ChatGPT-based chat has extended it.",
    watchOut: "Cloud reliance is the real risk — features depend on the company staying alive. Battery life per charge is short (it returns to its dock), and it's a companion, not a productivity tool.",
  },
  "sphero-mini-robot": {
    whyItWins: "A golf-ball-sized robot that's pure app-controlled fun — drive it around, play AR games, or use its block/JavaScript coding app to actually learn programming. Tiny, cheap, and surprisingly capable, with a real educational angle hiding inside the toy.",
    whoItsFor: "Kids, classrooms, coding beginners, and anyone with a cat that needs entertaining. People wanting an autonomous companion (rather than a remote-control ball) should look at Vector instead.",
    longTerm: "Sphero is an established education-robotics company with stable apps, so support is more dependable than novelty robots. The internal battery is the limit, but at this price it's an easy replacement call.",
    watchOut: "Runtime is about an hour per charge, and the fun is app-dependent — no phone, no robot. It's small enough to lose under furniture, as every cat owner eventually discovers.",
  },
  "lametric-smart-clock": {
    whyItWins: "A grown-up pixel display that turns information into desk decor — calendar, stocks, weather, smart-home status, even live metrics piped in via its open API. The LaMetric reads as intentional and professional on a desk that's on camera all day.",
    whoItsFor: "Remote workers, makers, and dashboards-on-a-desk types who want at-a-glance info with a polished app and developer hooks. If you just want a charming toy, the cheaper Divoom Ditoo is more fun per dollar.",
    longTerm: "LaMetric's app and API ecosystem have been stable for years, and the build is solid desk hardware. The developer integrations are the moat that keeps it genuinely useful long-term.",
    watchOut: "Pricey for a pixel clock, and the best features assume you'll set up apps and integrations. The low-res display is for glanceable data, not detail.",
  },
  "dji-mini-4-pro": {
    whyItWins: "Sub-250g so it skips the heaviest registration rules, yet it punches like a pro drone: 4K/60 HDR video, omnidirectional obstacle sensing, and genuinely intelligent subject tracking. It delivers cinematic aerials you can fly without a license class.",
    whoItsFor: "Travel and content creators who want broadcast-quality aerials in a backpack, and anyone nervous about drone regs (the sub-250g weight eases many). Casual flyers who just want to mess around can spend far less.",
    longTerm: "DJI's build and firmware support are the category standard, and the folding design survives travel well. Batteries are the consumable — the Fly More kit pays off, and props are cheap spares.",
    watchOut: "The real cost is accessories (extra batteries, ND filters) and the learning curve. Drone laws vary by country and keep changing — know your local rules, and the small sensor is its low-light weakness.",
  },
  "ipad-mini-7": {
    whyItWins: "The most pocketable real computer Apple makes. The A17 Pro chip means it never feels like a 'small' tablet — it flies through everything, runs full apps, takes Apple Pencil Pro for notes, and slips into a jacket pocket. For reading, travel, and one-handed use, nothing else is this capable at this size.",
    whoItsFor: "Readers, note-takers, travelers, and pilots/field users who want power in an 8-inch slab. If you want a laptop replacement or media canvas, a bigger iPad or iPad Air is the better screen.",
    longTerm: "iPads get many years of iOS updates and hold resale value better than almost any tablet — a long-horizon buy. The A17 Pro gives it headroom to stay fast for years.",
    watchOut: "Premium price for a small screen, and base storage fills fast — size up if you store media offline. Earlier minis showed a faint scrolling 'jelly' effect; minor, but worth knowing if you're sensitive to it.",
  },
  "benq-mobiuz-ex2710q": {
    whyItWins: "A 1440p 165Hz IPS that thinks about more than frame rate. BenQ's HDRi tone-mapping and genuinely good built-in 2.1 speakers (with a bass chamber) make it a complete desk centerpiece — fast for games, easy on the eyes, and it actually sounds decent without external speakers.",
    whoItsFor: "Gamers who want a do-it-all 1440p panel and value built-in sound and eye-comfort features. Pure competitive players chasing max Hz, or color pros, can find more specialized panels.",
    longTerm: "BenQ's panels and eye-care engineering have a strong reliability record, and the remote and sound features stay convenient for years. IPS of this generation ages with minimal backlight drift.",
    watchOut: "HDRi is tone-mapping, not true high-end HDR (local dimming is limited). The decent speakers are still monitor speakers — fine for casual use, not a substitute for real ones.",
  },
  "lg-49wq95c-ultrawide": {
    whyItWins: "One screen that replaces two 27-inch monitors with no bezel down the middle. This 49-inch 5K2K (5120×1440) curved ultrawide gives a seamless super-wide canvas, USB-C with charging, and a built-in KVM — the productivity dream for spreadsheets, timelines, and heavy multitasking.",
    whoItsFor: "Power multitaskers, traders, video editors, and developers who live in many windows at once. Gamers wanting the fastest panel, and small desks (this thing is enormous), should look elsewhere.",
    longTerm: "LG's ultrawide panels are mature and well-supported, and the USB-C/KVM features future-proof a one-cable desk. A big investment that tends to outlast several smaller monitors.",
    watchOut: "It demands desk depth and a GPU that can push 5120×1440. Pixel density is closer to 1440p than 4K-sharp, and it's productivity-first, not an esports panel.",
  },
  "focusrite-scarlett-solo": {
    whyItWins: "The audio interface that launched a million home studios. The Scarlett Solo's preamp is clean and quiet, the conversion punches above its price, and it supplies the 48V phantom power and gain real XLR mics need — the bridge from USB-mic hobbyist to proper recording.",
    whoItsFor: "Anyone moving to an XLR mic (AT2020, etc.) or recording an instrument, and podcasters who've outgrown USB. If you only ever use one USB mic, you don't need an interface at all.",
    longTerm: "Focusrite's Scarlett line is a decade-plus reliability story with strong driver support across OS updates — these run for years and hold resale value. No battery, simple rugged build.",
    watchOut: "The Solo has one XLR input — two-person podcasts need the 2i2. Very hungry mics like the SM7B want more gain than the Solo gives comfortably, so pair carefully or add a booster.",
  },
  "7hz-zero-2-iem": {
    whyItWins: "Twenty dollars, genuinely audiophile-tuned sound. The Zero 2 refines the original's Harman-style balance with cleaner bass, plus a detachable cable and metal nozzles — the IEM r/headphones hands to anyone who claims good audio has to be expensive.",
    whoItsFor: "Budget audiophiles, students, and anyone wanting a cheap beater IEM that doesn't insult their ears. People needing a mic or wireless should look at true-wireless buds instead.",
    longTerm: "The detachable 2-pin cable makes the usual IEM failure (cable death) a $10 fix, and there's nothing else to wear out — these outlive their price many times over. People usually lose them before breaking them.",
    watchOut: "No mic on the stock cable, so it's a listening tool, not a calls tool. Sound and isolation hinge entirely on tip fit — try the included sizes before judging.",
  },
  "hifiman-sundara-planar": {
    whyItWins: "Planar-magnetic sound at a price that broke the category open. The Sundara delivers fast, detailed, beautifully even sound with a spacious stage that dynamic headphones near its price can't match — a real step toward high-end listening without the high-end cost.",
    whoItsFor: "Curious audiophiles ready to hear what planar drivers do, and detail-focused listeners with a headphone amp. Bass-heavy genre fans and anyone without an amp should temper expectations.",
    longTerm: "HIFIMAN revised the Sundara's build over the years and current units are solid; pads are replaceable to refresh them. Planar drivers are durable and don't degrade like some dynamics.",
    watchOut: "Open-back (leaks sound, no isolation) and amp-hungry — a phone won't do it justice. Comfort is good, but the metal build is on the heavier side for very long sessions.",
  },
  "asus-rog-ally-x": {
    whyItWins: "The Windows handheld that fixed the original Ally's flaws: far bigger battery, more RAM, better ergonomics, same bright 120Hz 1080p screen. It runs your entire PC library — Steam, Game Pass, every launcher — natively, with more raw power than a Steam Deck.",
    whoItsFor: "Power users who want maximum performance and native Windows/Game Pass on the go and will tolerate some tinkering. People who want console-like simplicity should buy the Steam Deck OLED instead.",
    longTerm: "The upgradeable SSD and improved cooling bode well, and ASUS has supported it with firmware fixes. Windows handhelds need occasional driver/update maintenance — that's the long-term tax.",
    watchOut: "Windows on a handheld is still fiddly (touch targets, updates, sleep quirks) versus SteamOS. Battery life, while much improved, still drops fast in demanding AAA games.",
  },
  "lg-ultragear-27gp950": {
    whyItWins: "A 4K 144Hz Nano IPS with full HDMI 2.1 — built for the PS5/Xbox and high-end PC crowd who want 4K and high refresh, not a compromise between them. Fast response, vibrant wide-gamut color, and console 4K120 support in one panel.",
    whoItsFor: "Players with a 4K-capable GPU or current console who refuse to choose between resolution and refresh rate. 1440p gamers and budget builders are overspending here; this is a high-end pick.",
    longTerm: "LG's UltraGear panels are well-proven and the HDMI 2.1 support keeps it relevant across console generations. Nano IPS ages well with good color stability.",
    watchOut: "Driving 4K144 needs a serious GPU, and the edge-lit HDR (DisplayHDR 600) is good-not-great versus Mini-LED or OLED. IPS glow in dark scenes is the usual trade for the color and speed.",
  },
  "razer-viper-v3-pro": {
    whyItWins: "An esports scalpel: ~54 grams, Razer's latest 35K optical sensor, 8000Hz polling, and a symmetrical shape tuned with pro players. For fast, twitchy aim it's as close to 'the mouse is never the limiting factor' as it gets.",
    whoItsFor: "Competitive FPS players and anyone chasing the lightest, fastest wireless mouse. Everyone else is paying a pro tax — palm-grippers and button-lovers want the G502 X or Basilisk instead.",
    longTerm: "Optical switches sidestep double-click failure, and the minimalist build has little to break; pro-grade durability is the point. PTFE feet and a long battery round it out.",
    watchOut: "Bare-bones by design — no extra buttons, no RGB, no thumb rest, and a premium price. The ultra-light symmetric shape doesn't suit every hand; try the silhouette if you can.",
  },
  "corsair-vengeance-k65-tkl": {
    whyItWins: "A compact 75% wireless board that doesn't skimp: hot-swappable pre-lubed switches, dense PBT keycaps, and Corsair's reliable low-latency wireless plus Bluetooth. It keeps the arrow keys a 60% drops while still freeing major desk space.",
    whoItsFor: "Gamers and typists who want compact-but-not-cramped (75% keeps arrows and a function row) with the freedom to swap switches. Full-keyboard and numpad users should size up.",
    longTerm: "Hot-swap sockets mean a failed switch is a 10-second fix, and PBT caps resist shine — a board you can mod and keep for years. Corsair's wireless stack and build are dependable.",
    watchOut: "iCUE software is powerful but heavy on a PC. The 75% layout still compresses some keys into combos, and wireless gaming boards cost more than wired equivalents.",
  },
  "asus-rog-cetra-ii-earbuds": {
    whyItWins: "Wired USB-C gaming earbuds with real ANC — a rare combination. Low-latency wired audio (no Bluetooth lag) plus noise cancellation and a comfortable in-ear fit make them a stealth pick for handheld and mobile gaming where wireless latency ruins timing.",
    whoItsFor: "Steam Deck/ROG Ally and phone gamers who want low-latency audio without bulky headphones, and anyone whose device kept the USB-C port. People wanting wireless freedom or all-day music should look at true-wireless buds.",
    longTerm: "Wired means no battery to die — the cable is the wear point, the usual IEM-style failure to watch. Build is solid ROG hardware.",
    watchOut: "USB-C wired only — useless on a device without the port or the right adapter, and there's no wireless option. ANC is present but modest versus dedicated ANC earbuds.",
  },
  "herman-miller-aeron-chair": {
    whyItWins: "The office chair that became an icon because the ergonomics are genuinely that good. The Aeron's breathable mesh, precise posture support, and three sizes fit bodies properly — and the remaster modernized the materials. It's a 12-year-warranty, sit-in-it-all-day investment.",
    whoItsFor: "Anyone at a desk 8+ hours who's serious about their back and runs warm (the mesh doesn't trap heat like padded gaming chairs). Budget buyers and those who prefer a plush recline should look at a Secretlab.",
    longTerm: "The definition of buy-it-for-a-decade: a 12-year warranty, parts availability, and a used market that holds value better than any chair made. Aerons from the 2000s are still in daily service.",
    watchOut: "Expensive, and the firm mesh seat is a love-it-or-not feel — try one if you can. Get the right size (A/B/C) and the adjustable PostureFit lumbar, or you lose half the benefit.",
  },
  "caldigit-ts4-thunderbolt4": {
    whyItWins: "The Thunderbolt 4 dock professionals settle on. The TS4's 18 ports — including 98W laptop charging, 2.5G Ethernet, and full-speed Thunderbolt/USB — turn a single cable into an entire desk, with the bandwidth to drive dual displays and fast external SSDs at once. The no-compromise docking endgame.",
    whoItsFor: "Thunderbolt MacBook and laptop pros running multiple displays, fast storage, and wired networking from one cable. USB-C-only users or single-monitor desks should buy a cheap hub (or the Baseus) and save hundreds.",
    longTerm: "CalDigit's build and firmware support are top-tier, and Thunderbolt 4 is a durable standard — a multi-laptop, many-year purchase that holds resale value. Metal chassis, serious cooling.",
    watchOut: "Expensive, and it only makes sense with a Thunderbolt/USB4 host — a basic USB-C laptop can't use the bandwidth you're paying for. It's also a large, heavy desk unit, not portable.",
  },
  "anker-577-thunderbolt-hub": {
    whyItWins: "Most of a premium Thunderbolt dock's capability for noticeably less. The Anker 577 packs 13 ports including Thunderbolt 4, 85W+ charging, and dual-display support — a credible CalDigit alternative for people who want the bandwidth without the flagship price.",
    whoItsFor: "Thunderbolt laptop users who want a serious dock but balked at the TS4's price. Plain USB-C laptops and single-monitor setups don't need (and can't fully use) it.",
    longTerm: "Anker's build and warranty are dependable, and Thunderbolt 4 longevity carries the investment forward. Fewer niceties than the CalDigit, but the core is solid for years.",
    watchOut: "Charging wattage and some port speeds trail the TS4 — check specs if you push dual 4K60 plus fast storage at once. Like all TB docks, it needs a Thunderbolt/USB4 host to shine.",
  },
  "plugable-usbc-hub-11in1": {
    whyItWins: "A do-everything desktop hub with dual HDMI for people who don't have Thunderbolt. Eleven ports — twin displays, Ethernet, card readers, USB-A/C, pass-through charging — make it a budget docking station for ordinary USB-C laptops, with Plugable's strong driver support behind it.",
    whoItsFor: "Windows laptop users who want a two-monitor desk without Thunderbolt prices, and anyone who values a brand that actually maintains drivers. Mac users (display limits) and Thunderbolt owners have better-matched options.",
    longTerm: "Plugable is known for long-term driver and firmware support — a real differentiator for docks, which often get abandoned. The build is functional desk hardware that lasts.",
    watchOut: "Dual HDMI on non-Thunderbolt machines often relies on DisplayLink (a driver, with minor overhead) — fine for productivity, not gaming on the second screen. Base MacBooks still cap external displays regardless.",
  },
  "iniu-usbc-hub-8in1": {
    whyItWins: "An ultra-slim 8-in-1 that nails the travel-hub brief: 4K HDMI, Ethernet, USB-A/C, and card readers in an aluminum shell barely bigger than a phone. INIU's value pricing and famously long warranty make it the easy 'toss in the bag' pick.",
    whoItsFor: "Travelers and anyone who wants the common ports back from a thin laptop without bulk or expense. Desk-bound dual-monitor users want a docking-class hub instead.",
    longTerm: "INIU's long warranty and solid aluminum build punch above the price, and a simple feature set means little to fail. It runs warm under load like all compact hubs, which is normal.",
    watchOut: "Single HDMI and shared bandwidth mean it's a one-display general-purpose hub, not a docking station. As with any bus-powered hub, heavy simultaneous use generates heat.",
  },
  "elgato-facecam-pro": {
    whyItWins: "The first mainstream true-4K60 webcam, with a Sony sensor and a fixed-focus glass lens tuned for streaming. No autofocus hunting, manual control via Elgato's software, and uncompressed quality that makes it the webcam for creators who've outgrown 1080p.",
    whoItsFor: "Serious streamers and creators with the lighting and bandwidth to feed a 4K60 sensor. Meeting-only users are massively overspending — Zoom downsamples it anyway, and a C920 or C200 is plenty.",
    longTerm: "Elgato supports its camera/capture ecosystem well, and the fixed-focus glass design has fewer moving parts to fail than autofocus webcams. A buy-once tool for a serious setup.",
    watchOut: "4K60 demands real lighting and a capable PC, or you're paying for quality you won't see. It's premium-priced, and the fixed focus means you set your distance and stay in it.",
  },
  "microsoft-modern-webcam": {
    whyItWins: "A clean, no-nonsense 1080p webcam that looks tidy and just works. Microsoft's HDR and auto light adjustment handle typical office lighting well, the build is minimalist, and the integrated privacy shutter is built in — a calm, professional meeting camera.",
    whoItsFor: "Office and remote workers who want a reliable, good-looking 1080p upgrade over a laptop cam without features they'll never touch. Streamers and dim-room desks should look at the Razer Kiyo or a 2K/4K option.",
    longTerm: "Simple, well-built, and driverless (plug-and-play UVC) — it keeps working across OS updates for years. The privacy shutter is mechanical and durable.",
    watchOut: "It's 1080p with a smaller sensor, so dim rooms get noisy — lighting matters more than the camera here. No autofocus tricks or high frame rate; it's a meeting cam, not a content tool.",
  },
  "samsung-galaxy-buds3-pro": {
    whyItWins: "Samsung's answer to the AirPods Pro, and on a Galaxy phone it's just as seamless: excellent ANC, a blade-stem design with good controls, hi-res audio over Samsung's codec, and tight ecosystem integration like auto-switching and Find My. Genuinely flagship sound and noise cancellation.",
    whoItsFor: "Samsung Galaxy owners — that's where these unlock everything. iPhone users get the AirPods Pro experience instead, and other Android users lose the best codec and integration perks.",
    longTerm: "Samsung's firmware support is strong and the build is flagship-grade; same 2–3 year battery reality as all earbuds. Fit refinements over prior generations help long-wear comfort.",
    watchOut: "The value collapses off Samsung hardware — the hi-res codec and deep features are ecosystem-locked. Early units drew some fit debate, so the tip-fit test matters.",
  },
  "nothing-ear-2": {
    whyItWins: "Distinctive transparent design with real substance: a detailed hybrid-driver sound, LHDC hi-res support, solid ANC, and one of the best companion apps in the category with deep EQ. They look unlike anything else and back it up sonically.",
    whoItsFor: "Android users (especially Nothing/OnePlus phones) who want flagship features and standout looks for less than the big names. iPhone users lose the codec/app perks and should weigh AirPods.",
    longTerm: "Nothing has kept its earbuds updated with steady firmware, and the build feels more premium than the price. Battery aging is the usual earbud limit; the clear shell hides wear better than you'd expect.",
    watchOut: "Best sound needs LHDC support (mostly Android), and the transparent shell, while cool, is a fingerprint magnet. ANC is good, not Sony/Bose flagship-tier.",
  },
  "google-pixel-buds-pro-2": {
    whyItWins: "The Android counterpart to AirPods Pro, and on a Pixel they're magic: top-tier ANC, the Tensor chip enabling on-device features, hands-free Google Assistant done right, and a comfortable, secure fit. Clear, lively sound with Google's ecosystem glue.",
    whoItsFor: "Pixel and Google-ecosystem Android users who want the tightest integration and best Assistant experience. iPhone users should buy AirPods; other Android users get most, not all, of the benefit.",
    longTerm: "Google supports the Pixel Buds with feature updates, and build and fit improved over the first generation. Standard earbud battery lifespan applies.",
    watchOut: "Peak features (Assistant, conversation detection, best codec) lean on Pixel hardware. Premium price, and the touch controls take acclimation.",
  },
  "earfun-air-pro-4-anc": {
    whyItWins: "A budget overachiever that keeps winning value awards: strong adaptive ANC, the latest Bluetooth with multipoint and hi-res LDAC/aptX support, wireless charging, and a tunable app — features that read like a $150 earbud on a sub-$70 budget.",
    whoItsFor: "Value hunters and Android users who want near-flagship ANC and codecs without the price. If you want a name-brand ecosystem experience, the AirPods/Galaxy/Pixel buds integrate more deeply.",
    longTerm: "EarFun's firmware support has improved markedly and the case quality belies the price; expect the usual ~2-year battery arc. The low cost makes eventual replacement painless.",
    watchOut: "ANC and call quality are excellent for the price but a step below true flagships in the hardest conditions. The app's many options mean some tweaking to land your ideal tuning.",
  },
  "anker-3in1-cube-charger": {
    whyItWins: "A travel charging station that folds into a cube the size of a golf ball. It powers a MagSafe iPhone, an Apple Watch, and AirPods at once, folds flat for a bag, and clears three cables off the nightstand — clever engineering that solves the Apple-user travel mess.",
    whoItsFor: "iPhone + Apple Watch + AirPods owners who travel and hate carrying three chargers. Single-device users or non-Apple households don't need its specific three-way trick.",
    longTerm: "Anker's charging hardware is reliable and the hinge is built for repeated folding; MagSafe and Watch standards are stable, so it stays useful for years. No battery — it's a wall charger, so longevity is high.",
    watchOut: "It needs its own power brick and is Apple-ecosystem specific (MagSafe + Apple Watch puck). Fast Apple Watch charging support depends on the model — check if that matters to you.",
  },
  "elgato-ring-light": {
    whyItWins: "Big, even, flattering light with software control. The 17-inch ring throws soft wraparound illumination, dials in brightness and color temperature from your PC or Stream Deck, and mounts on a sturdy desk arm — the classic creator look, controllable without reaching for the light.",
    whoItsFor: "Streamers, video creators, and presenters who want that even, eye-catch-light look with app control. If you want directional, glare-free key lighting, the Elgato Key Light panel is the better tool.",
    longTerm: "LED longevity plus Elgato's mounting and software ecosystem make it a years-long fixture. The desk arm is solid enough to position once and forget.",
    watchOut: "Ring lights put a distinctive circular catchlight in your eyes and glasses (love-it-or-not), and the big ring eats desk space. App/network control means occasional reconnect fiddling.",
  },
  "elgato-stream-deck-plus": {
    whyItWins: "The Stream Deck, evolved: eight LCD keys plus four analog dials and a touch strip. The dials add smooth control over volume, EQ, light brightness, or video scrubbing — turning the macro pad into a tactile mixing surface for streamers and creative-app power users alike.",
    whoItsFor: "Streamers, audio/video editors, and pro-app users who want physical knobs for the things keys can't do well. If you only need button macros, the standard MK.2 is cheaper; casual users don't need either.",
    longTerm: "Elgato's plugin ecosystem keeps expanding and supports old hardware for years, so it stays useful well beyond purchase. The keys and dials are built for heavy daily use.",
    watchOut: "It's a premium 'nice to have,' not a necessity — OBS hotkeys are free. The dials are great once configured, but landing your ideal layout takes setup time.",
  },
  "avermedia-live-gamer-4k": {
    whyItWins: "An internal PCIe capture card for creators who want maximum fidelity: 4K60 HDR capture with ultra-low latency and no USB bottleneck. For a dedicated streaming PC build, it captures exactly what the source outputs.",
    whoItsFor: "Serious streamers running a two-PC setup or capturing 4K60 HDR who want internal-card performance. Most people are better served by the external Elgato HD60 X — this is for the dedicated-rig crowd.",
    longTerm: "AVerMedia's capture hardware is durable and well-driven, and an internal card avoids the wear of cables and enclosures. A buy-once component until capture standards leap.",
    watchOut: "Internal PCIe means a desktop with a free slot — no laptops, and installation is more involved. It's overkill and pricier than external cards unless you specifically need 4K60 HDR internal capture.",
  },
  "logitech-mx-brio-4k": {
    whyItWins: "Logitech's flagship webcam refined for the work-and-create crowd: a large 4K sensor, AI-driven low-light correction and auto-framing, and Show Mode for flipping the view to your desk. The premium meeting-and-content camera with software polish to match.",
    whoItsFor: "Professionals and creators who want top-tier image quality plus smart framing for calls and recording. Meeting-only users on compressed calls can save a lot with a C920 or C200.",
    longTerm: "Logitech's long support and MX-line build quality make it a durable desk fixture, and the 4K sensor leaves headroom as platforms improve. Firmware and features arrive via Logi software.",
    watchOut: "Premium price for quality most video calls will compress away, and the best features need Logitech's software running. Like all 4K cams, it rewards good lighting and a capable PC.",
  },
  "matter-smart-switch-eve": {
    whyItWins: "A privacy-first smart plug built on Matter/Thread, so it works across Apple Home, Google, Alexa, and SmartThings with no proprietary hub — and Eve's no-account, local-control ethos keeps your usage data home. It also tracks energy use, turning any device into a monitored, schedulable one.",
    whoItsFor: "Apple Home users especially (Eve's heritage) and anyone who wants Matter future-proofing plus genuine privacy. Bargain hunters who just want basic on/off scheduling can spend less on a Kasa plug.",
    longTerm: "Matter/Thread is the industry's converging standard, so this is among the most future-proof plugs you can buy, and Eve's local-first design won't get orphaned by a dead cloud. Solid build, steady firmware.",
    watchOut: "It costs more than Wi-Fi plugs like Kasa, and Thread needs a border router (a HomePod, Apple TV, or compatible Echo) to shine. Energy monitoring and the best experience lean toward the Apple ecosystem.",
  },
};
